              ...
              <div className="flex flex-col justify-center space-y-4">
                ...
                <div className="space-y-4">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    AptX uses AI to simplify teacher curriculum into visual, audio-rich, and adaptive lessons designed
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl font-headline">About AptX</h2>
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  We believe every child deserves an education that adapts to them. AptX was born from a passion to leverage technology to create truly inclusive learning environments for children with learning differences.
                </p>
              </div>
            </div>
        ...
        <section id="feedback" className="w-full py-12 md:py-24 lg:py-32 bg-muted/40">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
              ...
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed">
                Hear what educators and parents are saying about AptX.
              </p>
            </div>
            <div className="grid gap-8 md:grid-cols-2">
              <Card>
                <CardContent className="p-6">
                  <blockquote className="text-lg italic text-muted-foreground">
                    "AptX has been a game-changer in my classroom. I can finally provide differentiated instruction without spending hours adapting materials myself. The students are more engaged than ever!"
                  </blockquote>
              ...
              <Card>
                <CardContent className="p-6">
                  <blockquote className="text-lg italic text-muted-foreground">
                    "Watching my son learn with so much confidence has been incredible. The visual and audio supports are exactly what he needs. Thank you, AptX, for seeing his potential."
                  </blockquote>
                  <div className="flex items-center gap-4 mt-4">
      ...
      <footer className="bg-card text-card-foreground border-t">
        <div className="container py-12 px-4 md:px-6">
            <div className="grid gap-8 md:grid-cols-12">
                <div className="md:col-span-4 flex flex-col gap-4">
                    <Link href="#" className="flex items-center gap-2" prefetch={false}>
                        <AptxLogo className="h-8 w-8 text-primary" />
                        <span className="text-2xl font-bold">AptX</span>
                    </Link>
                    <p className="text-muted-foreground max-w-xs">
                        Transforming education with AI-powered accessible learning for students with Down syndrome. Built on Google Cloud.
                    </p>
            ...
            <div className="mt-8 border-t pt-6 text-center text-xs text-muted-foreground">
                &copy; {new Date().getFullYear()} AptX. All rights reserved.
            </div>
        </div>
      </footer>
